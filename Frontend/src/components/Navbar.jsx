...
const[sticky ,seStickey]=  useState(false );
useEffect(()=>{
    const handleScroll =()=>{
      if(window.scrollY>0){
        seStickey(true);
  ...
  return (
    <>
      <div className={`max-w-screen-2xl container dark:bg-slate-900 dark:text-white mx-auto md:px-20 px-4 fixed top-0 left-0 right-0 z-50 ${
          ...
          <div className="navbar-end space-x-3">
            ...
            <div className="hidden md:block">
              <label className=" px-3 py-2 border rounded-md flex items-center gap-2">
                <input type="text" className="  dark:bg-slate-900 dark:text-whitegrow outline-none" placeholder="Search" />
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 16 16"
                  fill="currentColor"
